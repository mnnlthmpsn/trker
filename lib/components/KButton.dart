...
class KButton extends StatefulWidget {
  ...
  KButton({ Key key, this.actionText, this.redirectPage, this.actionIcon, this.passed }) : super(key: key);
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          style: ButtonStyle(
              backgroundColor: MaterialStateProperty.all<Color>(widget.passed ? Colors.green : Colors.grey[200])
          ),
          child: Row(
